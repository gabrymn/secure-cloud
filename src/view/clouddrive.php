    ...
    <body>
        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark" style="border-bottom:1px solid #157EFB">
            <div class="container-fluid">
                <a class="navbar-brand" style="font-weight:900" href="#">Cloud Drive</a>
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" aria-current="page" href="settings.php">Profile</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link active" style="font-weight:900" aria-current="page"></a>
                        </li>
                        <button onclick="window.location.href='/signout'" class="btn btn-dark btn-secondary">
...
<script type="module">
    ...
    $('document').ready(() => {
        ...
        /*
        $.ajax({
            url: "http://localhost/api/__test.php",
            type: "GET",
            success: (response) => {
